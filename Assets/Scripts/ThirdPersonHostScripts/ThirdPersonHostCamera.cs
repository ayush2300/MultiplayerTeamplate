// Host-mode copy of the third-person view. Camera and input handling are pure local view code with
// no networking in them, so this is identical to the shared-mode version by design: each variant
// is self-contained, so you can retune ThirdPersonHostCamera here without touching the shared variant.
using UnityEngine;
using UnityEngine.InputSystem;

public class ThirdPersonHostCamera : MonoBehaviour, ILocalPlayerInput
{
